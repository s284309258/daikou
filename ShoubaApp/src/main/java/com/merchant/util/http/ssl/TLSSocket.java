...
public class TLSSocket extends SSLSocket {
	...
	public static final String[] SUPPORT_PROTOCOLS = { "SSLv3", "TLSv1",
			"TLSv1.1", "TLSv1.2" };
	public static final String[] ENABLED_PROTOCOLS = { "SSLv3", "TLSv1",
			"TLSv1.1", "TLSv1.2" };
	...
	public TLSSocket(String host, int port, TlsClientProtocol in,
			boolean selfSignPass) {
		super();
		this.host = host;
		this.port = port;
