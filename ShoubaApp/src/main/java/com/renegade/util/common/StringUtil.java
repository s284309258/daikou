...
public class StringUtil {
	...
	public static String EmptyStringMD5 = "D41D8CD98F00B204E9800998ECF8427E";
	


	public static String getSysDateTimeYMD(){
		return format1.format(new Date());
	}

	public static String getSysDateTimeY_M_D_h_m_s(){
		return format5.format(new Date());
	}

	public static String generateOrderId(String pfx){
		return pfx+format.format(new Date());
	}
	/**
...
//		System.out.println(isValidETHAddress("0x1111111111111111111111111111111111111111"));
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmssSSSS");
		System.out.println("FYH"+format.format(new Date()));
