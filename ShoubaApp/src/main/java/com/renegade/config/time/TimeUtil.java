...
public class TimeUtil {
	...
	private static SimpleDateFormat format4 = new SimpleDateFormat("yyyyMMddHHmmss");

	private static SimpleDateFormat format5 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	private static SimpleDateFormat format6 = new SimpleDateFormat("MM/dd/yyyy");

	private static SimpleDateFormat format7 = new SimpleDateFormat("yyyyMMddHHmm");

	private static SimpleDateFormat format8 = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	DateTimeFormatter formatter3 = DateTimeFormatter.ofPattern("HHmmss");
	...
	DateTimeFormatter formatter6 = DateTimeFormatter.ofPattern("yyyyMMddHHmm");
	 ...
	 * @return J8的安全方式
	 */
	public static String getJ8DayString() {
	...
	/**
	 * 获取某一天的时间，格式例如：  HHmmss
	 * 
	 * @return J8的安全方式
	 */
	public static String getJ8TimeString() {
	 ...
	 * @return
	 */
	public static long getTimeChuo(String timeString) {
		// 获取指定时间的时间戳，除以1000说明得到的是秒级别的时间戳（10位）
		long time = format4.parse(timeString, new ParsePosition(0)).getTime();
		return time;
	}
	 ...
	 */
	public static String getAfterHourString(String create_time, int hour) throws ParseException {
		Date createDate = StringToDate(create_time);
		Calendar cal = Calendar.getInstance();
		cal.setTime(createDate);
		cal.add(cal.HOUR_OF_DAY, hour);
//		cal.add(cal.MINUTE,hour);
		// cal.add(cal.SECOND,hour);
	 ...
	 * @throws ParseException
	 */
	public static String getAfterSecondString(String create_time, int second) throws ParseException {
		Date createDate = StringToDate(create_time);
		Calendar cal = Calendar.getInstance();
		cal.setTime(createDate);
	 ...
	 * @throws ParseException
	 */
	public static boolean compareAfterHour(String create_time, int hour) throws ParseException {
		String after_hour_String = getAfterHourString(create_time, hour);
		String curr_time_String = format4.format(new Date());
		// 固定时间几个小时之后的时间字符串大于当前时间字符串
		if (after_hour_String.compareTo(curr_time_String) > 0) {
			return true;
		} else {
			return false;
		}
	...
	public static boolean compareDate(Date date1, Date date2) {
		String date_str1 = format4.format(date1);
		String date_str2 = format4.format(date2);
		if (date_str1.compareTo(date_str2) > 0) {
			return true;
		} else {
			return false;
		}
	...
	/**
	 * 获取某一天时间,格式例如：yyyy-MM-dd HH:mm
	 * 
	 * @param date
	 * @return
	 */
	public static String get_format8() {
		return format8.format(new Date());
	}

	/**
	 * 日期格式转换 yyyy-MM-dd HH:mm:ss 转换成 yyyyMMddHHmmss
	 * 
	 * @param date
	 * @return
	 */
	 ...
	 * @throws ParseException
	 */
	public static String getAfterDayDate(String dateString, int day) throws ParseException {
		Date date = TimeUtil.StringToDate(dateString);
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	 ...
	 * @throws ParseException
	 */
	public static String getAfterDayTime(String dateString, int day) throws ParseException {
		Date date = TimeUtil.StringToDate(dateString);
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(cal.DAY_OF_MONTH, day);
	...
	public static String getEndDayOfLastMonthString() {
		...
		return format5.format(date.getTime());
	}
	...
	public static String dateFormat(Date date) {
		String dateString = format5.format(date);
		return dateString;
	}
	...
	public static Date StringToDate(String str) throws ParseException {
		str = format5.format(format4.parse(str));
		Date date = (Date) format5.parse(str);
		return date;
	}
	 ...
	 * @return
	 */
	public static String chuoToDate(Long chuo) {
		return format5.format(new Date(chuo));
	}
	 ...
	 * @return
	 */
	public static String millChuoToDate(double chuo) {
		return format5.format(chuo);
	}
	 ...
	 * @return
	 */
	public static Integer getWeekName(Date date) {
		Date today = new Date();
		Calendar c = Calendar.getInstance();
		c.setTime(today);
...
//    	System.out.println(CornUtil.getCron(TimeUtil.getAfterHourDate(TimeUtil.StringToDate("20190212160500"), SysParamConstant.star_create_hour)));
//    	System.out.println(getMondayAndSundayDate("20190324"));

		System.out.println(Instant.now().toEpochMilli());
		System.out.println(new Date().getTime());
		System.out.println(getWeekName(new Date()));
