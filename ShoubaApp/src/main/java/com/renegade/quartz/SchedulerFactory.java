...
import com.renegade.domain.ScheduleJobEntity;
...
public class SchedulerFactory
{
	 ...
	 */
	public boolean deleteJob(ScheduleJobEntity job) throws SchedulerException
	{
		try {
	 ...
	 * @throws SchedulerException
	 */
	public boolean addJob(ScheduleJobEntity job) throws SchedulerException
	{
		try {
